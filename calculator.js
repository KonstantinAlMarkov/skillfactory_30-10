...
class CalculatorLogic
{
    ...
    initNumButtons()
    {
        document.querySelectorAll('.calculatorButtonLane__buttonNum').forEach(item => {
    ...
    {
        document.querySelectorAll('.calculatorButtonLane__buttonOperator_twoOperators').forEach(item => {
            item.addEventListener('click', event => {
    ...
    {
        document.querySelectorAll('.calculatorButtonLane__buttonOperator_singleOperator').forEach(item => {
            item.addEventListener('click', event => {
    ...
    {        
        //кнопка сброса
        document.querySelector('.calculatorButtonLane__buttonAction_reset').addEventListener('click', event => {
            this.calculatorCore.calculatorReset();
        })
        //кнопка расчёта (работает только для двух операндов и оператора)
        document.querySelector('.calculatorButtonLane__buttonAction_calculate').addEventListener('click', event => {
...
class CalculatorCore
{
    ...
    constructor()
    {
        ...
        this.calculatorTablou = new CalculatorTablou(document.querySelector('.calculatorScreen__screen_viewOperand_disabled'),document.querySelector('.calculatorScreen_screen_viewResult_disabled'));   
